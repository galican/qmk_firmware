...
#define RGB_MATRIX_VAL_STEP 45
#define RGB_MATRIX_MINIMUM_BRIGHTNESS RGB_MATRIX_VAL_STEP
#define RGB_MATRIX_DEFAULT_VAL (RGB_MATRIX_VAL_STEP * 2)

#define RGB_MATRIX_SPD_STEP 64
#define RGB_MATRIX_MIN_SPD RGB_MATRIX_SPD_STEP
#define RGB_MATRIX_DEFAULT_SPD (RGB_MATRIX_MIN_SPD * 2)

#define RGB_MATRIX_SAT_STEP (255 / 4)
