...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_ansi( /* FN */
		...
		_______,          KC_APP,  _______, _______, _______, _______, _______, RGB_MOD, SW_OS1,  _______, _______, _______, _______, RGB_VAI, _______,
		_______, GU_TOGG, _______, _______,                   _______,                   _______, MO(4),   _______, _______, RGB_SPD, RGB_VAD, RGB_SPI),
    ...
    [3] = LAYOUT_ansi( /* FN */
		...
		_______, RGB_HUI, KC_VOLU, KC_VOLD, KC_MUTE, _______, KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT, KC_INS,  _______, _______, _______,          _______,
		_______,          KC_APP,  _______, _______, _______, _______, _______, RGB_MOD, SW_OS1,  _______, _______, _______, _______, RGB_VAI, _______,
		_______, _______, _______, _______,                   _______,                   MO(4),   _______, _______, _______, RGB_SPD, RGB_VAD, RGB_SPI),
